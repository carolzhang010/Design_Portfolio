...
export default function TitleIX() {
  ...
  return (
    <div>
      <h1 className="projectpageName">NYU Title IX</h1>
      <p className="projectpageDescriptionHeader">UX Research & Web Design</p>
      ...
      <div className="buttonContainer" style={{ marginTop: -10, textAlign: "center" }}>
        <a href="/TitleIX_FinalReport.pdf" download className="downloadButton">
          Final Report
        </a>
      </div>
